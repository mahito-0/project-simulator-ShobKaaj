...
<head>
    ...
    <link rel="stylesheet" href="/project-simulator-ShobKaaj/Management/Client/MVC/css/my-posted-jobs.css">
    ...
    <main class="my-jobs-container" style="margin-top: 100px; min-height: 80vh;">
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">Manage your job postings and proposals</p>
            </div>
            <div id="page-actions">
        ...
        <div class="panels-grid">
            ...
            <div class="job-panel">
                ...
                <div class="panel-content" id="open-list">
                    <!-- JS Populated -->
                </div>
            </div>
        </div>
